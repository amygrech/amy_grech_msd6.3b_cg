...
public class BoardManager : MonoBehaviourSingleton<BoardManager> {
	...
	public void UpdatePiecePosition(Square initialSquare, Square targetSquare) {
		Transform pieceTransform = GetPieceGOAtPosition(initialSquare)?.transform;
		Transform targetTransform = positionMap[targetSquare].transform;

		if (pieceTransform != null && targetTransform != null) {
			pieceTransform.parent = targetTransform;
			pieceTransform.position = targetTransform.position;
		}
	}
}
